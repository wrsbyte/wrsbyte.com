...
export const ui = {
  en: {
    ...
    "home.game_of_life.tip": "Left click or drag to add cells. Right click to remove cells.",
  ...
  es: {
    ...
    "home.game_of_life.tip": "Clic izquierdo o arrastrar para añadir células. Clic derecho para eliminar células.",
